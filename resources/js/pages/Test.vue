      ...
      <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Please select which category best fits your torrent.</p>
          </div>
        </div>
        ...
        <div>
          ...
          <input v-model="form.tags" type="text" placeholder="enter torrent tags here"
            class="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
          <p class="text-sm text-gray-500 mt-1">Tags examples: thriller,action,comedy (you can add 2 to 8 tags, don't
            forget to separate them with ",")</p>
        </div>
        ...
        <div>
          ...
          <div class="border border-gray-300 rounded-t-md bg-gray-50 p-2 flex flex-wrap gap-1">
            <button type="button" @click="insertTag('[b]', '[/b]')"
              class="px-3 py-1 border border-gray-300 rounded hover:bg-gray-200 font-bold" title="Bold">
              B
            </button>
            <button type="button" @click="insertTag('[i]', '[/i]')"
              class="px-3 py-1 border border-gray-300 rounded hover:bg-gray-200 italic" title="Italic">
              I
            </button>
            <button type="button" @click="insertTag('[u]', '[/u]')"
              class="px-3 py-1 border border-gray-300 rounded hover:bg-gray-200 underline" title="Underline">
              U
            </button>
            ...
            <button type="button" @click="insertTag('[code]', '[/code]')"
              class="px-3 py-1 border border-gray-300 rounded hover:bg-gray-200 font-mono" title="Code">
              &lt;/&gt;
            </button>
            ...
            <button type="button" @click="insertUrl" class="px-3 py-1 border border-gray-300 rounded hover:bg-gray-200"
              title="URL">
              🔗
            </button>
