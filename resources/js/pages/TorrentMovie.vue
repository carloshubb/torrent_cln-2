...
const { props } = usePage()
const torrents = ref(props.torrents);
...
async function deleteUploadTorrent(id) {
    torrentService.deleteTorrent(id)
        .then(res => {
            torrents.value = torrents.value.filter(function (row) {
                return row.id != id;
            })
        })
...
<template>
    ...
    <Head title="Your Torrents torrents" />
    <AppLayout>
                    ...
                    <table class="min-w-full">
                        <thead class="bg-gray-700">
                            <tr>
                                ...
                                <th class="hidden md:table-cell text-center px-4 py-1 text-gray-300 font-semibold">
                                    uploader
                                </th>
                            </tr>
                        </thead>
